...
// Header Title
$objPHPExcel->getActiveSheet()->setCellValue("B2", $setting_sistem['nama_sistem']." Laporan Anggota ".ucfirst($tipe));
...
if ($tipe=="keseluruhan") {
	$data_list = data_anggota_lengkap("", "", "aluni_anggota_dasar.id_anggota DESC");
}
else if ($tipe=="regional") {
	$data_list = data_anggota_lengkap("", "provinsi = '$id'", "aluni_anggota_dasar.id_anggota DESC");
}
else {
	$data_list = data_anggota_lengkap("", "$tipe = '$id'", "aluni_anggota_dasar.id_anggota DESC");
}
