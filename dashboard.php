				...
				<div class="row">
								...
								<form action="pencarian.php" method="post">
									...
									<div class="form-group">
										...
										<label class="checkbox" for="cari_provinsi">
											<input type="checkbox" data-toggle="checkbox" value="pro1.nama_provinsi" id="cari_provinsi" name="kategori_pencarian[]" class="custom-checkbox"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span> Provinsi
										</label>
										<label class="checkbox" for="cari_kota">
											<input type="checkbox" data-toggle="checkbox" value="kot1.nama_kota" id="cari_kota" name="kategori_pencarian[]" class="custom-checkbox"><span class="icons"><span class="icon-unchecked"></span><span class="icon-checked"></span></span> Kota
										</label>
					...
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
						<div class="panel panel-default">
							<div class="panel-body">
								<?php 
									$anggota_laki   = data_anggota_lengkap("nama_lengkap", "jenis_kelamin = 'laki-laki' AND aluni_anggota_dasar.aktif = 'ya'");
									$n_anggota_laki = count($anggota_laki);

									$anggota_perempuan   = data_anggota_lengkap("nama_lengkap", "jenis_kelamin = 'perempuan' AND aluni_anggota_dasar.aktif = 'ya'");
